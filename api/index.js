...
// Original (kept as comment so you know the source stayed the same):
// import apiConfig from "@/configs/apiConfig";

import apiConfig from "../configs/apiConfig"; // <-- changed to relative path so Vercel can resolve it
